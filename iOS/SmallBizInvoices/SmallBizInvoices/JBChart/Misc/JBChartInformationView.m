...
// Numerics
float const kJBChartValueViewPadding = 10.0f;
float const kJBChartValueViewSeparatorSize = 0.5f;
float const kJBChartValueViewTitleHeight = 50.0f;
float const kJBChartValueViewTitleWidth = 75.0f;
float const kJBChartValueViewDefaultAnimationDuration = 0.25f;
...
- (void)layoutSubviews
{
    ...
    float xOffset = ceil((self.bounds.size.width - (valueLabelSize.width + unitLabelSize.width)) * 0.5);
